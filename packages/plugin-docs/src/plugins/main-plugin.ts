...
module.exports = (api: any, opts: IParams) => {
  ...
  let demoContainerCssPath = path.resolve(
    __dirname,
    '../../src2/DemoContainer/index.css'
  );
  ...
  virtualModules[
    '/@DemoContainerCss'
  ] = `export { default } from '${demoContainerCssPath}';`;
  ...
  api.on('onChainWebpack', (config: Chain, env: Evnrioment) => {
    config
      ...
      .resolveLoader.alias.set(
        'demo-info-loader',
        path.resolve(__dirname, '../loaders/demo-info-loader')
      )
      .set(
        'js-file-static-meta-loader',
        path.resolve(__dirname, '../loaders/js-file-static-meta-loader')
      )
      .set(
        'md-file-static-meta-loader',
        path.resolve(__dirname, '../loaders/md-file-static-meta-loader')
      )
      .set(
        'type-info-loader',
        path.resolve(__dirname, '../loaders/type-info-loader')
      )
      .end()
      .end()
      .module.rule('md')

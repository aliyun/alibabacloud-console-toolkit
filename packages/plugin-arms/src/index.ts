...
!(function(c,b,d,a){c[a]||(c[a]={});c[a].config={pid:"${options.armsId}",imgUrl:"https://arms-retcode.aliyuncs.com/r.png?",enableSPA:true};
  with(b)with(body)with(insertBefore(createElement("script"),firstChild))setAttribute("crossorigin","",src=d)
    ...
    // arms 静态文件报错的脚本
    const armsStaticSourceTraceScripts = options.oneConsole ? '<meta data-type="oneconsole.arms_monitor" data-containerNodeId="#app" data-topbarNodeId="div[data-spm=console-base]" />' :
`<script>

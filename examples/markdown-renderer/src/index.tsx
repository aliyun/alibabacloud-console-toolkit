...
const consoleOSAppInfo = {
  "alicloud-component-demos": {
    servePath: "https://opensource-microapp.oss-cn-hangzhou.aliyuncs.com/app/alicloud-component-docs/",
    deps: {
      ...commonDeps,
    },
  },
...
render(<MarkdownRenderer source={md} toc xViewAppInfo={consoleOSAppInfo} />, document.querySelector(".app"));
